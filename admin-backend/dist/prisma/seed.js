...
async function main() {
    ...
    const memberData = [
        { memberId: 'DEMO001', lineUserId: 'Uline001', firstName: 'Sara', lastName: 'Chen', nationalType: 'THAI', citizenId: '1234567890123', email: 'sara@example.com', mobile: '0812345001', channel: 'LINE', gender: 'F', birthdate: birth, consentPDPA: true, pointBalance: 1250, levelCode: levelBlack ?? undefined },
        { memberId: 'DEMO002', lineUserId: 'Uline002', firstName: 'James', lastName: 'Wong', nationalType: 'OTHER', passport: 'A12345678', email: 'james@example.com', mobile: '0812345002', channel: 'LINE', gender: 'M', birthdate: birth, consentPDPA: true, pointBalance: 480, levelCode: levelSilver ?? undefined },
        { memberId: 'DEMO003', lineUserId: null, firstName: 'Nina', lastName: 'Smith', nationalType: 'OTHER', passport: 'B87654321', email: 'nina@example.com', mobile: '0812345003', channel: 'WEB', gender: 'F', birthdate: birth, consentPDPA: true, pointBalance: 2100, levelCode: levelSilver ?? undefined },
        { memberId: 'DEMO004', lineUserId: null, firstName: 'Mike', lastName: 'Lee', nationalType: 'THAI', citizenId: '9876543210123', email: 'mike@example.com', mobile: '0812345004', channel: 'WEB', gender: 'M', birthdate: birth, consentPDPA: false, pointBalance: 90, levelCode: levelYellow ?? undefined },
        { memberId: 'DEMO005', lineUserId: null, firstName: 'Priya', lastName: 'Patel', nationalType: 'OTHER', passport: 'C11223344', email: 'priya@example.com', mobile: '0812345005', channel: 'MOBILE', gender: 'F', birthdate: birth, consentPDPA: true, pointBalance: 750, levelCode: levelYellow ?? undefined },
        { memberId: 'DEMO006', lineUserId: 'Uline006', firstName: 'Tom', lastName: 'Brown', nationalType: 'THAI', citizenId: '1112223334444', email: null, mobile: '0812345006', channel: 'MOBILE', gender: 'M', birthdate: birth, consentPDPA: true, pointBalance: 0, levelCode: undefined },
    ];
    const members = [];
    for (const m of memberData) {
        const created = await prisma.member.upsert({
            ...
            update: { pointBalance: m.pointBalance, levelCode: m.levelCode ?? undefined },
        });
