...
async function main() {
    ...
    const memberData = [
        { memberId: 'DEMO001', lineUserId: 'Uline001', name: 'Sara', surname: 'Chen', nationalType: 'THAI', citizenId: '1234567890123', email: 'sara@example.com', mobile: '0812345001', displayName: 'Sara Chen', channel: 'LINE', sex: 'F', birthdate: birth, consentPDPA: true, pointBalance: 1250, memberLevelId: levelBlack },
        { memberId: 'DEMO002', lineUserId: 'Uline002', name: 'James', surname: 'Wong', nationalType: 'OTHER', passport: 'A12345678', email: 'james@example.com', mobile: '0812345002', displayName: 'James Wong', channel: 'LINE', sex: 'M', birthdate: birth, consentPDPA: true, pointBalance: 480, memberLevelId: levelSilver },
        { memberId: 'DEMO003', lineUserId: null, name: 'Nina', surname: 'Smith', nationalType: 'OTHER', passport: 'B87654321', email: 'nina@example.com', mobile: '0812345003', displayName: 'Nina Smith', channel: 'WEB', sex: 'F', birthdate: birth, consentPDPA: true, pointBalance: 2100, memberLevelId: levelSilver },
        { memberId: 'DEMO004', lineUserId: null, name: 'Mike', surname: 'Lee', nationalType: 'THAI', citizenId: '9876543210123', email: 'mike@example.com', mobile: '0812345004', displayName: 'Mike Lee', channel: 'WEB', sex: 'M', birthdate: birth, consentPDPA: false, pointBalance: 90, memberLevelId: levelYellow },
        { memberId: 'DEMO005', lineUserId: null, name: 'Priya', surname: 'Patel', nationalType: 'OTHER', passport: 'C11223344', email: 'priya@example.com', mobile: '0812345005', displayName: 'Priya Patel', channel: 'MOBILE', sex: 'F', birthdate: birth, consentPDPA: true, pointBalance: 750, memberLevelId: levelYellow },
        { memberId: 'DEMO006', lineUserId: 'Uline006', name: 'Tom', surname: 'Brown', nationalType: 'THAI', citizenId: '1112223334444', email: null, mobile: '0812345006', displayName: 'Tom Brown', channel: 'MOBILE', sex: 'M', birthdate: birth, consentPDPA: true, pointBalance: 0, memberLevelId: undefined },
    ];
    const members = [];
    for (const m of memberData) {
        const created = await prisma.member.upsert({
            ...
            create: {
                ...
                citizenId: m.citizenId ?? undefined,
                passport: m.passport ?? undefined,
                ...
                memberLevelId: m.memberLevelId ?? null,
            },
            update: { pointBalance: m.pointBalance, memberLevelId: m.memberLevelId ?? undefined },
        });
    ...
    for (const c of campaignData) {
        ...
        if (existing)
            ...
            campaigns.push(await prisma.campaign.create({ data: { ...c, validFrom, validTo, active: true } }));
    }
    for (const member of members) {
        const hasLedger = await prisma.pointLedger.count({ where: { memberId: member.id } });
        if (hasLedger > 0 || member.pointBalance <= 0)
            continue;
